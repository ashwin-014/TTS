...
fastpitch = onnx.load_model("models/v1/hi/final_unsqueeze_notranspose/fastpitch_unsqueeze_all_outputs.onnx")
...
onnx.save(gs.export_onnx(fastpitch_graph), "models/v1/hi/final_unsqueeze_notranspose/fastpitch_unsqueeze_identity_all_outputs.onnx")

fastpitch = onnx.load_model("models/v1/hi/final_unsqueeze_notranspose/fastpitch_unsqueeze_identity_all_outputs.onnx")
onnx.checker.check_model(fastpitch)
hifigan = onnx.load_model("models/v1/hi/final_unsqueeze_notranspose/vocoder_with_shape.onnx")
...
onnx.save(combined_model, "models/v1/hi/final_unsqueeze_notranspose/hififastpitch_with_shape_all_outputs.onnx")